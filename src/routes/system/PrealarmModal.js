 ...
 const SelectProps = {
  ...
  return (
    ...
    <Form layout="horizontal">
        ...
        <FormItem label="下限报警值" hasFeedback {...formItemLayout}>
          {getFieldDecorator('lowerlimitAlarmValue', {
            initialValue: item.lowerlimitAlarmValue,
            rules: [
              
            ],
          })(<InputNumber type="InputNumber" placeholder="" />)}
        </FormItem>
        <FormItem label="上线报警值" hasFeedback {...formItemLayout}>
          {getFieldDecorator('toplimitAlarmValue', {
            initialValue: item.toplimitAlarmValue,
            rules: [
